...
Shader "Shader Forge/LightPillarsSpinning" {
    Properties {
        ...
        _RotSpeed ("RotSpeed", Range(0, 2)) = 1
...
/////// Vectors:
                float4 node_917 = _Time + _TimeEditor;
                float4 node_1561 = _Time + _TimeEditor;
                float node_9444_ang = node_917.g;
                float node_9444_spd = (_RotSpeed*node_1561.g);
...
////// Lighting:
                float node_2431_ang = node_917.g;
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float faceSign = ( facing >= 0 ? 1 : -1 );
/////// Vectors:
                float4 node_1769 = _Time + _TimeEditor;
                float4 node_1561 = _Time + _TimeEditor;
                float node_9444_ang = node_1769.g;
                float node_9444_spd = (_RotSpeed*node_1561.g);
                float node_9444_cos = cos(node_9444_spd*node_9444_ang);
                float node_9444_sin = sin(node_9444_spd*node_9444_ang);
                float2 node_9444_piv = float2(0.5,0.5);
